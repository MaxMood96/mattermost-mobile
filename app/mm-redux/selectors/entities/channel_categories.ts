...
import {getCurrentChannelId, getMyChannelMemberships, makeGetChannelsForIds} from '@mm-redux/selectors/entities/channels';
...
import {getInt, getMyPreferences, getTeammateNameDisplaySetting, shouldAutocloseDMs} from '@mm-redux/selectors/entities/preferences';
